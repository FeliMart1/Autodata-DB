...
const categorizedFields = { Dimensiones: [], 'Mecanica': [], Equipamiento: [] };
...
\`;
  ...
  fields.forEach(f => {
    ...
    reactContent += \`                <label className="text-sm font-medium text-slate-700">\${f.name}</label>\\n\`;
...
fs.writeFileSync('frontend/scripts/generate-form-equipamiento.cjs', content, 'utf8');
