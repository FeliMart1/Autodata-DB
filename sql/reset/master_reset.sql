...
CREATE TABLE [dbo].[EquipamientoModelo] (
    ...
    -- Columnas legacy del Excel original (mantener para compatibilidad con importarExcelCompleto)
    ...
    [Controltraccin]                         NVARCHAR(100)   NULL,
    ...
    [Volantemultifuncin]                     NVARCHAR(100)   NULL,
